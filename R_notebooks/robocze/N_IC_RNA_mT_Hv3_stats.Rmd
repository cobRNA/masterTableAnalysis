...
read.table(file = '~/Desktop/mT/new-masterTable/formatted_RNA_Hv3_ICmT.tsv', sep = '\t', header = TRUE) %>% 
...
### Barplot
```{r}
#pdf(file = "IC_RNA_mT_sample_analysis_pre_and_post.pdf", width = 6, height = 4)
df_rna_basic %>%
  select(transcript_id, sampleN) %>% 
  distinct(transcript_id, sampleN) %>% 
  group_by(sampleN) %>% 
...
read.table(file = '~/Desktop/mT/new-masterTable/RNA_ICmT_Hv3_sample_stats.tsv', sep = '\t', header = FALSE) %>% 
...
#pdf(file = "IC_RNA_transcripts_by_technology.pdf", width = 6, height = 4)
p_rna_technology
...
#pdf(file = "IC_RNA_transcripts_by_technology_stacked.pdf", width = 3, height = 4)
p_rna_technology2
```
...
#pdf(file="IC_RNA_pre_cap_heatmap.pdf", width = 16, height = 8)
...
#pdf(file="IC_RNA_post_cap_heatmap.pdf", width = 16, height = 8)
...
#pdf(file="green_IC_RNA_preANDpost_cap_heatmap.pdf", width = 16, height = 8)
