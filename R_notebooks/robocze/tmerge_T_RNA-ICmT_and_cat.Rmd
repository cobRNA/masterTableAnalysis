...
115131
cat tmerged_T_RNA_ICmT_and_catalogs.loci.gff | awk '{print$10}' | sort | uniq | wc -l
415896
cat tmerged_T_RNA_ICmT_and_catalogs.loci.gff | awk '{print$38}' | sort | uniq | wc -l
113527
...
# Plot data
```{r}
#pdf(file = "tmerged_cat_and_T_RNA-ICmT.pdf", width = 6.2, height = 4)
df %>%
