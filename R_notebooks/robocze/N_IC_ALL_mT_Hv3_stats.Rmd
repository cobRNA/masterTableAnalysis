...
read.table(file = '~/Desktop/mT/new-masterTable/formatted_Hv3_ICmT.tsv', sep = '\t', header = TRUE) %>% 
  as_tibble() -> df_basic
df_basic
```
...
#pdf(file = "N_IC_ALL_target_plot", width = 6, height = 5)
...
#pdf(file = "IC_ALL_catalog_plot", width = 19, height = 5)
...
### Histogram
```{r}
#pdf(file = "IC_ALL_mT_sample_analysis_pre_and_post", width = 6, height = 4)
df_basic %>%
...
### Barplot
```{r}
#pdf(file = "N_IC_ALL_mT_sample_analysis_pre_and_post.pdf", width = 6, height = 4)
df_basic %>%
  select(transcript_id, sampleN) %>% 
  distinct(transcript_id, sampleN) %>% 
  group_by(sampleN) %>% 
...
read.table(file = '~/Desktop/mT/new-masterTable/ALL_ICmT_Hv3_sample_stats.tsv', sep = '\t', header = FALSE) %>% 
...
#pdf(file = "IC_ALL_transcripts_by_technology.pdf", width = 6, height = 4)
p_technology
...
#pdf(file = "N_IC_ALL_transcripts_by_technology_stacked.pdf", width = 3, height = 4)
p_technology2
...
#pdf(file="N_IC_ALL_pre_cap_heatmap.pdf", width = 16, height = 8)
p_pre_cap_heatmap
...
#pdf(file="N_IC_ALL_post_cap_heatmap.pdf", width = 16, height = 8)
p_post_cap_heatmap
...
#pdf(file="N_IC_ALL_preANDpost_cap_heatmap.pdf", width = 16, height = 8)
