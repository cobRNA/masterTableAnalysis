...
bind_rows(df_gencode_composition, df_mT_composition) %>% 
  ...
  theme(legend.position = "none",
        ...
        axis.text.y = element_text(colour="black",
                                  face="bold")) +
  #ggtitle(label="Transcript composition of masterTable and Gencode v.45 annotations") +
  scale_y_continuous(labels = scales::percent_format(),
                     limits = c(0,1)) -> bar_plot_composition
  
  
#pdf(file = "../Plots/mitochondrial_transcripts_composition_barplot.pdf", width = 6, height = 4)
bar_plot_composition
