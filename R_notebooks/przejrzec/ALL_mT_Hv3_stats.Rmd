...
#pdf(file = "ALL_target_plot", width = 6, height = 5)
...
### Barplot
```{r}
#pdf(file = "ALL_mT_sample_analysis_pre_and_post.pdf", width = 6, height = 4)
df_basic %>%
  select(transcript_id, sampleN) %>% 
  distinct(transcript_id, sampleN) %>% 
  group_by(sampleN) %>% 
...
```{r}
# Data contains the header
read.table(file = '~/Desktop/mT/ALL_mT_Hv3_transcript-sampleN.tsv', sep = '\t', header = FALSE) %>% 
  as_tibble() %>%
...
read.table(file = '~/Desktop/mT/ALL_mT_Hv3_sample_stats.tsv', sep = '\t', header = FALSE) %>% 
...
#pdf(file = "ALL_transcripts_by_technology_stacked.pdf", width = 3, height = 4)
p_technology2
...
#pdf(file="ALL_pre_cap_heatmap.pdf", width = 16, height = 8)
p_pre_cap_heatmap
...
#pdf(file="ALL_post_cap_heatmap.pdf", width = 16, height = 8)
p_post_cap_heatmap
...
#pdf(file="ALL_preANDpost_cap_heatmap.pdf", width = 16, height = 8)
